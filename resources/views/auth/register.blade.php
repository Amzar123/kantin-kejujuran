...
<section class="min-vh-100 mb-8"> 
    ...
    <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        ...
        <div class="card z-index-0">
            ...
            <div class="card-body">
            <form role="form text-left" action="/create-register" method="post">
                @csrf
                <div class="mb-3">
                <input type="text" class="form-control" placeholder="Name" aria-label="Name" name="name" aria-describedby="username-addon">
                </div>
                <div class="mb-3">
